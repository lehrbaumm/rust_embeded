...
extern crate stm32f103xx_hal;  //  Hardware Abstraction Layer (HAL) for STM32 Blue Pill.
...
use stm32f103xx_hal::delay::Delay;  //  Delay timer.
use stm32f103xx_hal::prelude::*;  //  Define HAL traits.
use stm32f103xx_hal::stm32f103xx::Peripherals;  //  Clocks, flash memory, GPIO for the STM32 Blue Pill.
